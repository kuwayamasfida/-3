...
    'btn-strength': { start: 15, end: 20, url: 'https://www.sfidax.jp/company/' },
    ...
    'btn-choice': { start: 25, end: 30, url: 'https://www.sfidax.jp/recruit/' },
    // HTML ID: btn-example
    'btn-example': { start: 35, end: 40, url: 'https://maruwa-kainyou.com/' },
    // HTML ID: btn-caution (注意点)
    'btn-caution': { start: 45, end: 50, url: 'https://www.sfidax.jp/access/' } // 新しいタイミングを設定
};
